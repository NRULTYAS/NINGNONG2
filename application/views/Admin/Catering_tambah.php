...
<div class="max-w-2xl py-6">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-primary font-heading">Tambah Paket Catering</h1>
            <p class="text-text-muted">Tambah paket nasi kotak baru</p>
        </div>
    </div>
    ...
    <div class="bg-surface rounded-2xl shadow-sm border border-border-subtle p-6">
        ...
        <form action="<?php echo base_url('admin/catering/tambah'); ?>" method="post" enctype="multipart/form-data">
            <div class="mb-5">
                ...
                <input type="text" name="nama_paket" required class="w-full px-4 py-3 rounded-xl border border-border-subtle focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-surface shadow-sm transition">
            </div>
            <div class="grid grid-cols-2 gap-6 mb-5">
                ...
                <div>
                    ...
                    <input type="number" name="porsi" required class="w-full px-4 py-3 rounded-xl border border-border-subtle focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-surface shadow-sm transition">
                </div>
            </div>
            <div class="mb-5">
                <label class="block text-sm font-semibold text-text-main mb-2 flex items-center gap-2">
                ...
                <textarea name="isi_paket" rows="4" required class="w-full px-4 py-3 rounded-xl border border-border-subtle focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-surface shadow-sm transition resize-none" placeholder="Contoh: Nasi + Ayam Goreng + Sayur + Kerupuk + Buah"></textarea>
            </div>
            <div class="mb-5">
                <label class="block text-sm font-semibold text-text-main mb-2 flex items-center gap-2">
