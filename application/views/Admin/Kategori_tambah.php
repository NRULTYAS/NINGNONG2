    ...
    <div class="bg-white rounded-2xl p-8 border border-coklat-muda/20">
        ...
        <form action="<?php echo base_url('admin/kategori/tambah'); ?>" method="post">
            <div class="mb-4">
                ...
                <input type="text" name="nama_kategori" required class="w-full px-4 py-3 rounded-xl border border-coklat-muda/30 focus:outline-none focus:border-coklat-tua bg-krem/30">
            </div>
            <div class="mb-6">
