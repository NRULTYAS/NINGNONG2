...
<div class="max-w-2xl">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-coklat-tua">Edit Produk</h1>
            <p class="text-gray-500">Ubah data produk</p>
        </div>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-coklat-muda/20 shadow-lg shadow-coklat-muda/10">
        ...
        <form action="<?php echo base_url('admin/produk/edit/'.$produk->id_produk); ?>" method="post" enctype="multipart/form-data">
            <div class="mb-5">
                ...
                <input type="text" name="nama_produk" value="<?php echo $produk->nama_produk; ?>" required class="w-full px-4 py-3 rounded-xl border border-coklat-muda/30 focus:outline-none focus:border-coklat-tua focus:ring-2 focus:ring-coklat-tua/10 bg-white shadow-sm transition">
            </div>
            <div class="grid grid-cols-2 gap-4 mb-5">
                ...
                <div>
                    ...
                    <input type="text" name="rasa" value="<?php echo $produk->rasa; ?>" required class="w-full px-4 py-3 rounded-xl border border-coklat-muda/30 focus:outline-none focus:border-coklat-tua focus:ring-2 focus:ring-coklat-tua/10 bg-white shadow-sm transition">
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4 mb-5">
                <div>
                    ...
                    <input type="number" name="harga" value="<?php echo $produk->harga; ?>" required class="w-full px-4 py-3 rounded-xl border border-coklat-muda/30 focus:outline-none focus:border-coklat-tua focus:ring-2 focus:ring-coklat-tua/10 bg-white shadow-sm transition">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
                    ...
                    <input type="number" name="stok" value="<?php echo $produk->stok; ?>" required class="w-full px-4 py-3 rounded-xl border border-coklat-muda/30 focus:outline-none focus:border-coklat-tua focus:ring-2 focus:ring-coklat-tua/10 bg-white shadow-sm transition">
                </div>
            </div>
            <div class="mb-5">
                <label class="block text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
                ...
                <textarea name="deskripsi" rows="3" class="w-full px-4 py-3 rounded-xl border border-coklat-muda/30 focus:outline-none focus:border-coklat-tua focus:ring-2 focus:ring-coklat-tua/10 bg-white shadow-sm transition resize-none"><?php echo $produk->deskripsi; ?></textarea>
            </div>
            <div class="mb-8">
                <label class="block text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
                ...
                <div class="mb-3 p-3 bg-krem/30 rounded-xl inline-block">
                    <img src="<?php echo base_url('assets/upload/'.$produk->gambar); ?>" class="w-32 h-32 object-cover rounded-xl border border-coklat-muda/20 shadow-sm">
                </div>
                <?php endif; ?>
                <div class="relative">
