...
<section class="py-12 bg-background min-h-screen relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <?php echo form_open('catering_checkout/proses', ['class' => 'contents', 'enctype' => 'multipart/form-data']); ?>
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-surface/80 backdrop-blur-sm rounded-2xl p-6 border border-border-subtle/20 sticky top-24 shadow-sm">
                    ...
                    <button type="submit" id="btn-submit-catering" class="block w-full py-3.5 bg-primary text-white rounded-full font-medium hover:bg-primary-hover transition-all duration-200 text-center flex items-center justify-center gap-2 shadow-md shadow-primary/20">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const btnSubmit = document.getElementById('btn-submit-catering');
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.querySelector('form[action*="catering_checkout/proses"]');
    if (form) {
