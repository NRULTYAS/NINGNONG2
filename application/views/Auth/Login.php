    ...
    <div class="w-full max-w-5xl grid md:grid-cols-2 gap-8 items-center relative z-10">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl shadow-coklat-muda/20 border border-coklat-muda/20">
            <div class="text-center mb-8">
                <h2 class="text-2xl font-bold text-coklat-tua mb-1">Selamat Datang</h2>
            ...
            <p class="text-center mt-6 text-gray-400 text-sm">Belum punya akun? <a href="<?php echo base_url('auth/register'); ?>" class="text-coklat-tua font-semibold hover:underline">Daftar</a></p>
        </div>
    </div>
</body>
</html>
